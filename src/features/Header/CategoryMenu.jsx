...
export default function CategoryMenu() {
  ...
  return (
    <>
      ...
      <div
        className={`absolute top-0 right-0 z-50 flex h-full w-[500px] flex-col gap-4 bg-gray-50 p-4 transition-transform duration-300 ${isOpenMenu ? "translate-x-0" : "translate-x-full"}`}
      >
